...
namespace PracticeWPF.ViewModelSample
{
    ...
    /// </summary>
    public class RelayCommandSanple01 : ICommand
    {
        ...
        public RelayCommandSanple01(Action execute)
            : this(execute, null)
        {
        }
        ...
        public RelayCommandSanple01(Action execute, Func<bool> canExecute)
        {
            if (execute == null)
        ...
        /// <summary>
        /// 現在の状態でこの <see cref="RelayCommandSanple01"/> が実行できるかどうかを判定します。
        /// </summary>
        ...
        /// <summary>
        /// 現在のコマンド ターゲットに対して <see cref="RelayCommandSanple01"/> を実行します。
        /// </summary>
        /// <param name="parameter">
        /// コマンドによって使用されるデータ。コマンドが、データの引き渡しを必要としない場合、このオブジェクトを null に設定できます。
        /// </param>
